...
if args.helixer:
    repos += [
        ...
        (git_home_dir + 'writing_transfer_learning', 'git@github.com:alisandra/writing_transfer_learning.git'),
    ]
...
if args.work:
    repos += [
        ...
        (git_home_dir + 'trace.detection', 'git@git-prem.gfz-potsdam.de:trace/trace.detection.git'),
