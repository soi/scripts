...
alias gfz='cd ~/git/2020-03-gfz-remote-sensing/gfz_202003'
...
alias heh='cd ~/git/HelixerPrep/helixer'
alias hed='cd ~/git/HelixerPrep/helixer/testdata'
alias hep='cd ~/git/HelixerPrep/helixer/prediction'
alias hev='cd ~/git/HelixerPrep/helixer/visualization'
...
alias ali='ssh -A -o "ProxyJump felix@134.99.224.59" felix@134.99.224.62'
alias chris='ssh -A -o "ProxyJump felix@134.99.224.59" felix@134.99.224.57'
